...
int main(){
    ...
    cvNamedWindow("Noise Removal Image",CV_WINDOW_AUTOSIZE);
    ...
    dst_image = cvCreateImage(cvGetSize(img), IPL_DEPTH_8U, 1);
    
    cvSmooth(noise, dst_image,CV_BLUR,3,3);
    
    cvShowImage("Noise Removal Image", dst_image);
