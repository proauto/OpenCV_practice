...
int main(){
    ...
    //load images
    src_image1 = cvLoadImage("/Users/ihong-gyu/MyProject/OpenCVTest/photo1.jpg",0);
    src_image2 = cvLoadImage("/Users/ihong-gyu/MyProject/OpenCVTest/photo1.jpg",0);
    ...
    //subtract two images
    dst_image = cvCreateImage(cvGetSize(src_image1),IPL_DEPTH_8U, 1);
